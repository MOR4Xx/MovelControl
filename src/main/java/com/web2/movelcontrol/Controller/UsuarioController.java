...
public class UsuarioController {
        ...
        @Operation(summary = "Cadastrar um novo usuário", description = "Cria um usuário no sistema com os dados informados", responses = {
                        ...
                        @ApiResponse(responseCode = "400", description = "Requisição inválida devido a dados de entrada incorretos ou incompletos.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = UsuarioRequestDTO.class)))
        })
        ...
        @Operation(summary = "Buscar usuário por ID", description = "Retorna os dados de um usuário específico pelo seu ID", responses = {
        ...
        @Operation(summary = "Buscar usuário por Nome", description = "Retorna os dados de um usuário específico pelo seu ID", responses = {
                        @ApiResponse(responseCode = "200", description = "Usuário encontrado", content = @Content(mediaType = "application/json", schema = @Schema(implementation = UsuarioResponseDTO.class))),
                        @ApiResponse(responseCode = "404", description = "Usuário não encontrado"),
                        @ApiResponse(responseCode = "500", description = "Erro interno do servidor.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponseDTO.class)))
        })
        ...
        @Operation(summary = "Lista todos os Usuarios", description = "Retorna uma lista com todos os usuarios do sistema", responses = {
                        @ApiResponse(responseCode = "200", description = "Usuários Encontrados", content = @Content(mediaType = "application/json", schema = @Schema(implementation = UsuarioResponseDTO.class))),
        ...
        @Operation(summary = "Atualizar um usuário", description = "Atualiza os dados de um usuário existente pelo ID", responses = {
        ...
        @Operation(summary = "Deletar um usuário", description = "Remove um usuário do sistema pelo seu ID", responses = {
